...
def index(items: list[dict]) -> dict:
    ...
    keep = ("id", "kind", "title", "summary", "build", "style", "zone", "surfaces", "shelf", "tags",
            "uses", "derived-from", "palettes", "treatments", "status", "preview", "prompt", "command")
    ...
    return {"$comment": "yoshiki registry — generated by tools/build.py from canon/**/manifest.yml. Do not edit.",
            "counts": counts, "styles": styles, "items": entries}
